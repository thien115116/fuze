...
import Avatar3 from "constants/18.png";
  ...
  return (
    <Wrapper>
      <div className="banner">
        ...
        <div type="img-1" className="imgBx2">
          <img src={Avatar3} alt="abc" />
        </div>
        <div type="img-2" className="imgBx2">
          <img src={Avatar3} alt="abc" />
        </div>
        <div type="img-3" className="imgBx2">
          <img src={Avatar3} alt="abc" />
        </div>
        <div type="img-4" className="imgBx2">
          <img src={Avatar3} alt="abc" />
        </div>
